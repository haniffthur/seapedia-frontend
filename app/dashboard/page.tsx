...
// Utility function untuk membaca payload dari token JWT
...
export default function Home() {
  ...
  useEffect(() => {
    // Cek status login dan baca role dari token
  ...
  const handleAddToCart = async (productId: string) => {
    ...
    // Proteksi UI: Cegah Seller memasukkan barang ke keranjang
        ...
        <div className="space-x-4 flex items-center">
          ...
          {isLoggedIn ? (
            <>
              ...
              {/* RENDER JIKA ROLE ADALAH SELLER */}
              {activeRole === 'SELLER' && (
                <Link href="/dashboard/seller" className="text-gray-600 hover:text-blue-600 font-medium text-sm">Dashboard Toko</Link>
              )}
              
              {activeRole === 'DRIVER' && (
                <Link href="/dashboard/driver" className="text-gray-600 hover:text-blue-600 font-medium text-sm">Radar Driver</Link>
              )}
                ...
                <div className="p-4 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto pt-4 space-y-3 border-t">
                    ...
                    <button 
                      ...
                      disabled={p.stock < 1}
                      className={`w-full py-2 rounded text-sm font-bold transition shadow-sm ${
                        p.stock < 1 
